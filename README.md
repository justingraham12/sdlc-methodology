...
- [`ai-augmented-delivery-principles.md`](organized/ai-augmented-delivery-principles.md):
...
- [`practices/spec-acceptance-gate.md`](organized/practices/spec-acceptance-gate.md): the
